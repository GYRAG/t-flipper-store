...
COMMON_INCLUDES=(
    ...
    -I"$PROJECT_DIR/components/flipper_application/flipper_application"
    -I"$PROJECT_DIR/components/flipper_format"
    -I"$PROJECT_DIR/components/dialogs"
    -I"$PROJECT_DIR/components/locale"
    -I"$PROJECT_DIR/components/datetime"
    -I"$PROJECT_DIR/components/datetime/datetime"
    ...
    -I"$PROJECT_DIR/lib"
    -I"$PROJECT_DIR/lib/infrared"
    -I"$PROJECT_DIR/lib/infrared/worker"
    -I"$PROJECT_DIR/lib/infrared/encoder_decoder"
    -I"$PROJECT_DIR/lib/infrared/signal"
    -I"$PROJECT_DIR/applications/main"
