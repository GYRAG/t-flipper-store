...
static const struct sym_entry firmware_api_table[] = {
    ...
    { .hash = 0x00ad2969, .address = (uint32_t)mf_classic_get_blocks_num_in_sector }, /* mf_classic_get_blocks_num_in_sector */
    ...
    { .hash = 0x01bc28a9, .address = (uint32_t)bit_lib_crc8 }, /* bit_lib_crc8 */
    ...
    { .hash = 0x0681c778, .address = (uint32_t)mbedtls_md_hmac_finish }, /* mbedtls_md_hmac_finish */
    ...
    { .hash = 0x075786c3, .address = (uint32_t)&I_ButtonDown_7x4 }, /* I_ButtonDown_7x4 */
    ...
    { .hash = 0x0939d78b, .address = (uint32_t)&sequence_set_blue_255 }, /* sequence_set_blue_255 */
    ...
    { .hash = 0x0ad78581, .address = (uint32_t)infrared_worker_tx_start }, /* infrared_worker_tx_start */
    ...
    { .hash = 0x0bebf7ef, .address = (uint32_t)slix_alloc }, /* slix_alloc */
    ...
    { .hash = 0x100dcd55, .address = (uint32_t)subghz_protocol_raw_gen_fff_data }, /* subghz_protocol_raw_gen_fff_data */
    ...
    { .hash = 0x10963151, .address = (uint32_t)slix_set_uid }, /* slix_set_uid */
    ...
    { .hash = 0x1419e6d8, .address = (uint32_t)infrared_worker_set_decoded_signal }, /* infrared_worker_set_decoded_signal */
    ...
    { .hash = 0x14ed707b, .address = (uint32_t)mf_ultralight_poller_read_page }, /* mf_ultralight_poller_read_page */
    ...
    { .hash = 0x1633d73f, .address = (uint32_t)mf_ultralight_poller_auth_pwd }, /* mf_ultralight_poller_auth_pwd */
    { .hash = 0x16410b41, .address = (uint32_t)mbedtls_md_free }, /* mbedtls_md_free */
    { .hash = 0x16420e38, .address = (uint32_t)mbedtls_md_hmac }, /* mbedtls_md_hmac */
    { .hash = 0x16429ff3, .address = (uint32_t)mbedtls_md_init }, /* mbedtls_md_init */
    ...
    { .hash = 0x1adbbd68, .address = (uint32_t)subghz_environment_set_alutech_at_4n_rainbow_table_file_name }, /* subghz_environment_set_alutech_at_4n_rainbow_table_file_name */
    ...
    { .hash = 0x1e827bba, .address = (uint32_t)ble_profile_hid_mouse_move }, /* ble_profile_hid_mouse_move */
    ...
    { .hash = 0x228fb062, .address = (uint32_t)subghz_environment_set_came_atomo_rainbow_table_file_name }, /* subghz_environment_set_came_atomo_rainbow_table_file_name */
    ...
    { .hash = 0x2594eab8, .address = (uint32_t)mbedtls_md_hmac_starts }, /* mbedtls_md_hmac_starts */
    ...
    { .hash = 0x28210cc5, .address = (uint32_t)furi_message_queue_reset }, /* furi_message_queue_reset */
    ...
    { .hash = 0x29e03ee7, .address = (uint32_t)ble_profile_hid_consumer_key_release_all }, /* ble_profile_hid_consumer_key_release_all */
    { .hash = 0x29f836ba, .address = (uint32_t)mbedtls_md_hmac_update }, /* mbedtls_md_hmac_update */
    ...
    { .hash = 0x2d901617, .address = (uint32_t)infrared_signal_alloc }, /* infrared_signal_alloc */
    { .hash = 0x2dbf275a, .address = (uint32_t)infrared_worker_set_raw_signal }, /* infrared_worker_set_raw_signal */
    ...
    { .hash = 0x35140ab2, .address = (uint32_t)nfc_poller_start_ex }, /* nfc_poller_start_ex */
    ...
    { .hash = 0x35eeba02, .address = (uint32_t)infrared_send_raw }, /* infrared_send_raw */
    ...
    { .hash = 0x37e3f494, .address = (uint32_t)&sequence_blink_blue_10 }, /* sequence_blink_blue_10 */
    ...
    { .hash = 0x3a93e77b, .address = (uint32_t)ble_profile_hid_consumer_key_press }, /* ble_profile_hid_consumer_key_press */
    ...
    { .hash = 0x3c4fd2d6, .address = (uint32_t)subghz_protocol_raw_file_encoder_worker_set_callback_end }, /* subghz_protocol_raw_file_encoder_worker_set_callback_end */
    { .hash = 0x3c5cebac, .address = (uint32_t)furi_hal_subghz_stop_async_rx }, /* furi_hal_subghz_stop_async_rx */
    ...
    { .hash = 0x3fae2750, .address = (uint32_t)subghz_environment_set_nice_flor_s_rainbow_table_file_name }, /* subghz_environment_set_nice_flor_s_rainbow_table_file_name */
    ...
    { .hash = 0x413cfe94, .address = (uint32_t)furi_hal_subghz_start_async_rx }, /* furi_hal_subghz_start_async_rx */
    ...
    { .hash = 0x42639fe5, .address = (uint32_t)iso14443_4a_free }, /* iso14443_4a_free */
    ...
    { .hash = 0x4693abfd, .address = (uint32_t)&I_DolphinSaved_92x58 }, /* I_DolphinSaved_92x58 */
    ...
    { .hash = 0x4948367f, .address = (uint32_t)__floatdisf }, /* __floatdisf */
    ...
    { .hash = 0x4cbcf83e, .address = (uint32_t)infrared_signal_transmit }, /* infrared_signal_transmit */
    ...
    { .hash = 0x4ed074d6, .address = (uint32_t)furi_hal_hid_consumer_key_release }, /* furi_hal_hid_consumer_key_release */
    ...
    { .hash = 0x52fe7a1c, .address = (uint32_t)furi_hal_rfid_tim_read_stop }, /* furi_hal_rfid_tim_read_stop */
    ...
    { .hash = 0x53de7161, .address = (uint32_t)mbedtls_aes_crypt_ctr }, /* mbedtls_aes_crypt_ctr */
    { .hash = 0x53f6e9c4, .address = (uint32_t)ble_profile_hid_mouse_release }, /* ble_profile_hid_mouse_release */
    { .hash = 0x54803eb8, .address = (uint32_t)view_commit_model }, /* view_commit_model */
    { .hash = 0x548a89c6, .address = (uint32_t)&I_back_10px }, /* I_back_10px */
    ...
    { .hash = 0x57d1dd5c, .address = (uint32_t)furi_hal_power_check_otg_fault }, /* furi_hal_power_check_otg_fault */
    ...
    { .hash = 0x5a0aa496, .address = (uint32_t)type_4_tag_free }, /* type_4_tag_free */
    ...
    { .hash = 0x619d2ae0, .address = (uint32_t)ble_profile_hid_kb_release_all }, /* ble_profile_hid_kb_release_all */
    ...
    { .hash = 0x634996ba, .address = (uint32_t)iso14443_4a_get_historical_bytes }, /* iso14443_4a_get_historical_bytes */
    ...
    { .hash = 0x65e0c595, .address = (uint32_t)&I_Ble_disconnected_15x15 }, /* I_Ble_disconnected_15x15 */
    ...
    { .hash = 0x67a23dc1, .address = (uint32_t)&sequence_blink_start_blue }, /* sequence_blink_start_blue */
    ...
    { .hash = 0x6a9661ac, .address = (uint32_t)iso14443_3a_set_sak }, /* iso14443_3a_set_sak */
    ...
    { .hash = 0x6ae73ccb, .address = (uint32_t)mf_ultralight_get_pwd_page_num }, /* mf_ultralight_get_pwd_page_num */
    ...
    { .hash = 0x6d813a22, .address = (uint32_t)furi_hal_hid_consumer_key_press }, /* furi_hal_hid_consumer_key_press */
    ...
    { .hash = 0x6ea0fc50, .address = (uint32_t)iso14443_4a_set_uid }, /* iso14443_4a_set_uid */
    ...
    { .hash = 0x740f6487, .address = (uint32_t)&sequence_blink_red_10 }, /* sequence_blink_red_10 */
    ...
    { .hash = 0x830c051e, .address = (uint32_t)infrared_worker_rx_enable_blink_on_receiving }, /* infrared_worker_rx_enable_blink_on_receiving */
    ...
    { .hash = 0x83f82d54, .address = (uint32_t)&I_dir_10px }, /* I_dir_10px */
    ...
    { .hash = 0x860a634a, .address = (uint32_t)subghz_custom_btns_reset }, /* subghz_custom_btns_reset */
    ...
    { .hash = 0x86eb1df6, .address = (uint32_t)furi_hal_infrared_is_busy }, /* furi_hal_infrared_is_busy */
    ...
    { .hash = 0x876f6795, .address = (uint32_t)infrared_signal_set_signal }, /* infrared_signal_set_signal */
    ...
    { .hash = 0x899c4f4a, .address = (uint32_t)iso15693_3_poller_send_frame }, /* iso15693_3_poller_send_frame */
    ...
    { .hash = 0x8bcd2db1, .address = (uint32_t)mf_classic_get_sector_trailer_num_by_sector }, /* mf_classic_get_sector_trailer_num_by_sector */
    ...
    { .hash = 0x8e785531, .address = (uint32_t)infrared_worker_rx_enable_signal_decoding }, /* infrared_worker_rx_enable_signal_decoding */
    { .hash = 0x8e79f72e, .address = (uint32_t)iso14443_4a_alloc }, /* iso14443_4a_alloc */
    ...
    { .hash = 0x8fa9dda6, .address = (uint32_t)iso14443_4a_reset }, /* iso14443_4a_reset */
    ...
    { .hash = 0x99e80f6a, .address = (uint32_t)subghz_receiver_search_decoder_base_by_name }, /* subghz_receiver_search_decoder_base_by_name */
    ...
    { .hash = 0x9b0191ff, .address = (uint32_t)type_4_tag_alloc }, /* type_4_tag_alloc */
    ...
    { .hash = 0x9f0997b2, .address = (uint32_t)&gpio_cc1101_g0 }, /* gpio_cc1101_g0 */
    ...
    { .hash = 0xa3480c86, .address = (uint32_t)slix_free }, /* slix_free */
    ...
    { .hash = 0xa44d05ae, .address = (uint32_t)infrared_signal_free }, /* infrared_signal_free */
    { .hash = 0xa4536268, .address = (uint32_t)infrared_signal_read }, /* infrared_signal_read */
    ...
    { .hash = 0xa9e6da59, .address = (uint32_t)subghz_devices_get_name }, /* subghz_devices_get_name */
    ...
    { .hash = 0xab43dc6f, .address = (uint32_t)ble_profile_hid_consumer_key_release }, /* ble_profile_hid_consumer_key_release */
    { .hash = 0xab8b1082, .address = (uint32_t)subghz_devices_set_async_mirror_pin }, /* subghz_devices_set_async_mirror_pin */
    { .hash = 0xabb42e5a, .address = (uint32_t)mbedtls_md_hmac_reset }, /* mbedtls_md_hmac_reset */
    ...
    { .hash = 0xb1ad3b30, .address = (uint32_t)&I_sub1_10px }, /* I_sub1_10px */
    ...
    { .hash = 0xb28830fc, .address = (uint32_t)furi_hal_subghz_is_frequency_valid }, /* furi_hal_subghz_is_frequency_valid */
    { .hash = 0xb2cd82c4, .address = (uint32_t)furi_hal_rfid_tim_read_start }, /* furi_hal_rfid_tim_read_start */
    ...
    { .hash = 0xb778c69e, .address = (uint32_t)mf_ultralight_is_all_data_read }, /* mf_ultralight_is_all_data_read */
    ...
    { .hash = 0xbb7a8f61, .address = (uint32_t)type_4_tag_set_uid }, /* type_4_tag_set_uid */
    ...
    { .hash = 0xbd590a54, .address = (uint32_t)iso14443_3a_set_atqa }, /* iso14443_3a_set_atqa */
    ...
    { .hash = 0xc231836d, .address = (uint32_t)&sequence_blink_green_100 }, /* sequence_blink_green_100 */
    { .hash = 0xc2449939, .address = (uint32_t)infrared_worker_tx_stop }, /* infrared_worker_tx_stop */
    ...
    { .hash = 0xca826427, .address = (uint32_t)dir_walk_close }, /* dir_walk_close */
    ...
    { .hash = 0xcbdfc307, .address = (uint32_t)infrared_worker_tx_set_get_signal_callback }, /* infrared_worker_tx_set_get_signal_callback */
    ...
    { .hash = 0xd338e0bf, .address = (uint32_t)mbedtls_md_info_from_type }, /* mbedtls_md_info_from_type */
    ...
    { .hash = 0xd5564c53, .address = (uint32_t)subghz_setting_delete_custom_preset }, /* subghz_setting_delete_custom_preset */
    ...
    { .hash = 0xd6342752, .address = (uint32_t)ble_profile_hid_mouse_scroll }, /* ble_profile_hid_mouse_scroll */
    ...
    { .hash = 0xd7e45695, .address = (uint32_t)&I_Ble_connected_15x15 }, /* I_Ble_connected_15x15 */
    ...
    { .hash = 0xdadae9de, .address = (uint32_t)&gpio_speaker }, /* gpio_speaker */
    ...
    { .hash = 0xdb5521e7, .address = (uint32_t)&sequence_blink_cyan_100 }, /* sequence_blink_cyan_100 */
    ...
    { .hash = 0xdd9f4a73, .address = (uint32_t)mf_classic_copy }, /* mf_classic_copy */
    ...
    { .hash = 0xdf46d350, .address = (uint32_t)mbedtls_md_setup }, /* mbedtls_md_setup */
    ...
    { .hash = 0xe225380b, .address = (uint32_t)furi_hal_hid_mouse_release }, /* furi_hal_hid_mouse_release */
    ...
    { .hash = 0xe2f1ac17, .address = (uint32_t)furi_hal_hid_mouse_press }, /* furi_hal_hid_mouse_press */
    ...
    { .hash = 0xe553eebc, .address = (uint32_t)ble_profile_hid_mouse_release_all }, /* ble_profile_hid_mouse_release_all */
    ...
    { .hash = 0xe6534b28, .address = (uint32_t)subghz_protocol_decoder_base_deserialize }, /* subghz_protocol_decoder_base_deserialize */
    ...
    { .hash = 0xe6ae4491, .address = (uint32_t)mbedtls_aes_setkey_enc }, /* mbedtls_aes_setkey_enc */
    ...
    { .hash = 0xe7bc80b0, .address = (uint32_t)&I_ButtonUp_7x4 }, /* I_ButtonUp_7x4 */
    ...
    { .hash = 0xeb79a989, .address = (uint32_t)&I_ButtonRight_4x7 }, /* I_ButtonRight_4x7 */
    ...
    { .hash = 0xecb985a5, .address = (uint32_t)infrared_worker_tx_get_signal_steady_callback }, /* infrared_worker_tx_get_signal_steady_callback */
    ...
    { .hash = 0xed601bac, .address = (uint32_t)nfc_listener_tx }, /* nfc_listener_tx */
    ...
    { .hash = 0xef099b90, .address = (uint32_t)ble_profile_hid_mouse_press }, /* ble_profile_hid_mouse_press */
    ...
    { .hash = 0xefa7f9aa, .address = (uint32_t)mf_ultralight_poller_write_page }, /* mf_ultralight_poller_write_page */
    ...
    { .hash = 0xf1da4997, .address = (uint32_t)nfc_device_set_uid }, /* nfc_device_set_uid */
    ...
    { .hash = 0xf53bb818, .address = (uint32_t)subghz_transmitter_get_protocol_instance }, /* subghz_transmitter_get_protocol_instance */
    ...
    { .hash = 0xf7aebd9d, .address = (uint32_t)nfc_device_is_equal }, /* nfc_device_is_equal */
    ...
    { .hash = 0xf91ff9f4, .address = (uint32_t)furi_hal_power_get_usb_voltage }, /* furi_hal_power_get_usb_voltage */
    ...
    { .hash = 0xfb6244f4, .address = (uint32_t)&sequence_blink_start_red }, /* sequence_blink_start_red */
    ...
    { .hash = 0xfe13acb6, .address = (uint32_t)iso14443_4a_get_base_data }, /* iso14443_4a_get_base_data */
    { .hash = 0xfe2b16b2, .address = (uint32_t)mjs_get_context }, /* mjs_get_context */
    { .hash = 0xfe355712, .address = (uint32_t)storage_file_eof }, /* storage_file_eof */
